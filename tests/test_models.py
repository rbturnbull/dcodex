...
class FamilyTests(TestCase):
    ...
    def test_affiliation_verses(self):
        ...
        affiliation = family1.add_manuscript_at_verses(
            ms, [verse for verse in verses if verse.rank % 2 == 0]
        )
    ...
    def test_affiliation_range(self):
        ...
        affiliation = family.add_manuscript_range(
            ms, start_verse=verses[1], end_verse=verses[5]
        )
    ...
    def test_affiliation_overlap(self):
        ...
        family1.add_affiliated_family_range(
            family2, start_verse=verses[3], end_verse=verses[8]
        )
